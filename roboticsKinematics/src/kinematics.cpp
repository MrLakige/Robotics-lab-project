...
/*
* Compute the homogeneous tranformation matrix of the N joint of the Robotic arm (using the transformation of Denavit-Hartenberg)
*/
...
/*
* Compute the forward kinematics of the Robotic arm 
*   - allows to retrieve the gripper position regarding the position of the base
*/
...
*   - allows to retrieve the joints positions
*/
...
/*
* Function to get one of the solution out of all the possible solutions to reach the desired position of the grippper
*/
...
/*
* Function to get the gripper position and orientation given the joints
*/
